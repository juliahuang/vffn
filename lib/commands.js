function commands(service) {
  ...
  function animate() {
    for (i in animateQueue) {
      ...
      if (cmd === 'flicker') {
        if (Math.random() > 0.5) { 
          //packet = [0xAA, animation.split(' ')[1], 100, 255, 255];
          packet = [0xAA, animation.split(' ')[1], 255, 100, 0];
        } else {
          //packet = [0xAA, animation.split(' ')[1], 50, 120, 120];
          packet = [0xAA, animation.split(' ')[1], 140, 60, 0];
        }
